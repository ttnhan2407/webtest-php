...
<div class="login-container"> 
                ...
                <p>Bạn đã có tài khoản ? <a href="<?php echo BASE_URL ?>khachhang/dangnhap">Đăng nhập</a>
            </div>
                <form action="<?php echo BASE_URL ?>giohang/dathang" name="frmDatHang" method="POST" autocomplete="off" class="login-form">
                <input type="text" name="name" class="login-text" placeholder="Nhập họ và tên">
                <input type="mail"name="email" class="login-text" placeholder="Nhập địa chỉ email">
                <input type="telephone" name="sodienthoai" class="login-text" placeholder="Số điện thoại">
                <input type="text" name="diachi" class="login-text" placeholder="Địa chỉ/ KV/ Phường,Xã/ Quận,Huyện/ Tỉnh,Thành Phố ">
                <textarea type="text" name="noidung" class="login-contact" cols="30" rows="10" placeholder="Nội dung"></textarea>
                <input type="submit" class="login-submit" value="Đặt mua">
                <input type="reset" class="login-submit" style="cursor:pointer" value="Nhập lại">
            </form>
