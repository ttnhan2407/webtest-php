  ...
  <table class="table table-striped">
    ...
    ?>
      <tr>
        ...
        <td><a href="<?php echo BASE_URL?>post/delete_post?id=<?php echo $pos['id_post']?>">Xóa</a> || <a href="<?php echo BASE_URL?>post/edit_post?id=<?php echo $pos['id_post']?>">Cập nhật</a> </td>
      </tr>
    <?php
        }
    ?>
